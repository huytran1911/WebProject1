...
<?php
    // Bước 1: Lấy sản phẩm từ cơ sở dữ liệu
    ...
    // Bước 2: Kiểm tra xem có sản phẩm nào không
    if(mysqli_num_rows($result) > 0) {
        // Bước 3: Lưu sản phẩm đã lấy vào biến
        $products = [];
                            ...
                            <div class="price">
                                ...
                                <form action="" method="post" class="product">
                                    <div class="product-image">
                                       ...
                                       <a href="category.php?category=<?= $fetch_products['cid']; ?>" class="category"><?= $fetch_products['productName']; ?></a>
                                       <div class="name"><?= $fetch_products['productName']; ?></div>
                                       <div class="price"><?= $fetch_products['price']; ?><span>đ</span></div>
                                       <div class="quantity">
                                             <input type="number" name="qty" class="qty" min="1" max="99" value="1" maxlength="2">
                                             <button type="submit" class="add-to-cart" name="add_to_cart"><i class="fas fa-shopping-cart"></i></button>
                                       </div>
